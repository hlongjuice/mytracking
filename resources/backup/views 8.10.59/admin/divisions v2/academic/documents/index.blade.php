    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-xs-12 col-md-4">
                <a href={{route('admin.documents.create',['academic','9'])}} class="btn btn-default">เพิ่มเอกสาร</a>
            </div>
            <div class="col-xs-12">
                <table class="table">
                    <thead>
                    ...
                    @foreach($documents as $document)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="{{route('admin.documents.edit',['academic','9',$document->id])}}">แก้ไข</a>
                            </td>
                            <td>
