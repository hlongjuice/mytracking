...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-4">
                <a href={{route('admin.activities.create','management',68)}}>เพิ่มบทความ</a>
            </div>
            <div class="col-xs-12">
                <table class="table">
                    <thead>
                    ...
                    @foreach($contents as $content)
                        <tr>
                            ...
                            <td><a href={{route('admin.activities.edit',['management',$content->id])}}>{{$content->title}}</a></td>
                            <td>{{date('d-m-Y', strtotime($content->created_at))}}</td>
                            <td><a href="{{route('admin.activities.edit',['management',$content->id])}}" class="btn btn-info ">แก้ไข</a></td>
