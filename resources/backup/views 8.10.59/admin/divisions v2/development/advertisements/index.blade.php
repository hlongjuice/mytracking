...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">ระบบจัดการเอกสารประชามสัมพันธ์ ฝ่ายบริพัฒนากิจการนักเรียนนักศึกษา</div>
        <div class="panel-body">
            <div class="col-xs-12 col-md-4">
                <a href={{route('admin.advertisements.create','academic')}} class="btn btn-default">เพิ่มเอกสาร</a>
            </div>
            <div class="col-xs-12">
                <table class="table">
                    <thead>
