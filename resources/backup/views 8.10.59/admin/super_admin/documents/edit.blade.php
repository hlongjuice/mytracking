...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">ระบบแก้ไขเอกสาร</div>
        <div class="panel-body">
            {{Form::open([
            'route'=>['super_admin.documents.update',$document->id],
            'method'=>'PATCH',
            'files'=>true
            ])}}
            ...
            <div class="col-xs-12 col-md-12 form-group">
                ...
                {{Form::text('link',$document->link,['class'=>'form-control','value'=>old('link')])}}
            </div>
