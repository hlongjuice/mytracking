...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">แก้ไขระบบจัดการเอกสารประชาสัมพันธ {{$division->title}}</div>
        <div class="panel-body">
            {{Form::open([
            'route'=>['admin.advertisements.update',$division->id,$advertisement_id,$document->id],
            'method'=>'PATCH',
            'files'=>true
            ])}}
