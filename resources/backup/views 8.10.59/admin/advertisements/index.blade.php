...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">ระบบจัดการเอกสารประชาสัมพันธ์ {{$division->title}}</div>
        <div class="panel-body">
            <div class="col-xs-12 col-md-4">
                <a href={{route('admin.advertisements.create',[$division->id,$advertisement_id])}} class="btn btn-default">เพิ่มเอกสาร</a>
            </div>
            <div class="col-xs-12">
                <table class="table">
                    <thead>
                    ...
                    @foreach($documents as $document)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="{{route('admin.advertisements.edit',[$division->id,$advertisement_id,$document->id])}}">แก้ไข</a>
                            </td>
                            <td>
