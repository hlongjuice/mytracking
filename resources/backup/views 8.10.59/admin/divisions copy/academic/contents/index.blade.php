...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-4">
                <a href={{route('admin.divisions.academic.contents.create')}}>เพิ่มบทความ</a>
            </div>
            <div class="col-xs-12">
                <table class="table">
                    <thead>
                    ...
                    @foreach($contents as $content)
                        <tr>
                            ...
                            <td><a href={{route('admin.divisions.academic.contents.edit',$content->id)}}>{{$content->title}}</a></td>
