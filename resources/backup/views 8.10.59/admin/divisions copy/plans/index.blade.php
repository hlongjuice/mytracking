                ...
                <div  class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-6 col-md-3 admin-menu">
                            <a href={{route('admin.divisions.plans.contents.index')}}>
                                <div class="icon">
                        ...
                        <div class="col-xs-6 col-md-3 admin-menu">
                            <a href={{route('admin.divisions.plans.activities.index')}}>
                                <div class="icon">
                                    <i class="fa fa-tag"></i>
                                </div>
                                <div class="title">
                        ...
                        {{--</div>--}}
                        <div class="col-xs-6 col-md-3 admin-menu">
                            <a href={{route('admin.divisions.plans.documents.index')}}>
                                <div class="icon">
